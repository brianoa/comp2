            ...
            <ul class="vertical-nav-menu">
                <li class="mm-active <?= $presentervisibility ?> <?= $managementvisibility ?> <?= $stationmanagementvisibility ?> <?= $customercarevisibility ?>">
                    ...
                    <ul class="mm-collapse mm-show">
                        ...
                        <li class="<?= in_array(Yii::$app->user->identity->email, Yii::$app->myhelper->getMembers(array(''), array(47))) ? '' : 'hidden' ?>">
                            <?= Html::a('<i class="metismenu-icon fa fa-clock"></i> Transaction Log', Url::to(['/transactionlog/index']), ['class' => '']) ?>
                        </li>
                    </ul>
                </li>

                <li class="<?= $presentervisibility ?> <?= $managementvisibility ?> <?= $stationmanagementvisibility ?> <?= $customercarevisibility ?>" title="User Administration" data-content="User Management Module. Menu options to manage, edit, view, create users.">
                ...
                <li class="<?= $presentervisibility ?> <?= $managementvisibility ?>  <?= $customercarevisibility ?>" title="User Administration" data-content="User Management Module. Menu options to manage, edit, view, create users.">
                ...
                <li class="<?= $managementvisibility ?> " data-content="Application Management Options. Add/Edit/View Application(s) options" title="Application Management">
                ...
                <li class="<?= $presentervisibility ?> <?= $managementvisibility ?> <?= $stationmanagementvisibility ?>  <?= $customercarevisibility ?>" data-content="Application Management Options. Add/Edit/View Application(s) options" title="Application Management">
                ...
                <li class="<?= $presentervisibility ?> <?= $managementvisibility ?> <?= $stationmanagementvisibility ?> <?= $customercarevisibility ?>" title=" Module" data-content="Role Based Access Control Management for the applications. Set up Roles and Rules for the different managed Applications">
