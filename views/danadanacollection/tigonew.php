...
$this->title= 'Tigo | Confirmed Payments';
...
<div class="panel panel-inverse">
    ...
    <div class="panel-body">
        <div class="container-fluid">
            ...
            <?php
            echo Html::beginForm(
                $action = yii\helpers\Url::base() . "/mpesapayments/tigonew",
                $method = 'post',
                $hmtmlOptions = array(
                    'id'      => 'vodacom',
            ...
            <div class="form-group ">
                <div class="col-sm-4">
                    <input  class="form-control"type="text" name="reference" placeholder="Enter Reference" value=""/>
                </div>
            </div>
            <div class="form-group field-file ">
                ...
                <div class="help-block p-t-10">Example: tigo.csv</div>
            </div>
            <div class="form-group ">
                <div class="col-sm-4">
